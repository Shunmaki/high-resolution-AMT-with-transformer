...
NOTE_CHECKPOINT_PATH="/notebooks/maki/high-resolution-AMT-with-transformer/bestmodel/160000_iterations_transformer.pth"

# --- 1. Train note transcription system ---
#python3 pytorch/main.py train --workspace=$WORKSPACE --model_type='Regress_onset_offset_frame_velocity_CRNN' --loss_type='regress_onset_offset_frame_velocity_bce' --augmentation='none' --max_note_shift=0 --batch_size=10 --learning_rate=5e-4 --reduce_iteration=150000 --resume_iteration=0 --early_stop=160000 --cuda
